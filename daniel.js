...
function process(){
    try {
        const {
            ...
            console.log("cominf here ",average_no_of_docs_processed_per_day,
            no_of_employees,);
            ...
            const time_saved_per_day = get_time_saved_per_day(average_no_of_docs_processed_per_day , time_in_minutes_to_process_single_doc,employee_hours_per_day, automation_factor)
 ...
 * @param {average_no_of_docs_processed_per_day , time_in_minutes_to_process_single_doc,employee_hours_per_day, automation_factor}
 */
 function get_time_saved_per_day(average_no_of_docs_processed_per_day , time_in_minutes_to_process_single_doc,employee_hours_per_day, automation_factor) {
   /**
    * formulla result = (average_no_of_docs_processed_per_day*(time_in_minutes_to_process_single_doc/60)*automation_factor)
    */
   return Math.ceil((average_no_of_docs_processed_per_day*(time_in_minutes_to_process_single_doc/60)*automation_factor))
}
